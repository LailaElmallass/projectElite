...
const resources = {
  en: {
    translation: {
      ...
      "login": "Login",
      "dashboard": "Dashboard",
      "welcome": "Welcome {{nomComplet}}! Here's an overview of your journey and opportunities.",
  ...
  fr: {
    translation: {
      ...
      "welcome": "Bienvenue {{nomComplet}} ! Voici un aperçu de votre parcours et vos opportunités.",
  ...
  ar: {
    translation: {
      ...
      "welcome": "مرحبًا {{nomComplet}}! إليك نظرة عامة على مسيرتك وفرصك.",
